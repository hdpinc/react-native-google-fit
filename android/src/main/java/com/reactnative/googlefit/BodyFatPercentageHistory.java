...
public class BodyFatPercentageHistory {

    private ReactContext mReactContext;
    private GoogleFitManager googleFitManager;

    private static final String TAG = "BodyFatPercentageHistory";

    public BodyFatPercentageHistory(ReactContext reactContext, GoogleFitManager googleFitManager){
    ...
    private void processDataSet(DataSet dataSet, WritableArray map) {
        ...
        for (DataPoint dp : dataSet.getDataPoints()) {
            ...
            for(Field field : dp.getDataType().getFields()) {
                ...
                WritableMap bodyFatPercentageMap = Arguments.createMap();
